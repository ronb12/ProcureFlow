...
export default function FinalAuditPackagesPage() {
  ...
  const handleViewPackage = (pkg: any) => {
    ...
    router.push(`/audit-packages/${pkg.id}`);
  };
  ...
  // Filter packages - moved outside of render to avoid dependency issues
  const filteredPackages = mockAuditPackages.filter(pkg => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading audit packages...</p>
        </div>
      </div>
    );
  }
